...
- Avatar color and profile customization choices
...
### Push Notifications
If you opt in, we collect a push notification token to send you reminders and updates. You can opt out at any time through your device settings.
...
- Allow friends to see your activity (subject to your privacy settings)
- Moderate photo submissions to verify quest completions
...
Your data is stored using Supabase, a secure cloud database provider. Photos are stored in Supabase's secure object storage. We use industry-standard security practices including row-level security policies to ensure users can only access their own data.
...
You can control your privacy settings within the app, including blocking specific friends from seeing your location on the map.
...
We retain your data for as long as your account is active. If you delete your account, your personal data, quest completions, and photos will be deleted within 30 days. Some anonymized aggregate data may be retained for analytics purposes.
